...
//connsole.log("Hello from JS.GetTrustedConfig")
////debugger;
//
//  $.ajax({
//          type: "GET",
  ...
  $.ajax({
          ...
          success: function (result) {
            debugger;
             ...
             $('#Earlier_Results_Status').text("Success...!!")
...
function ShowImage(ImageId){
    console.log("Testing from show image")
